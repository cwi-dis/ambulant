...
#     define AMBULANT_NO_LIMITS
// Note: <ambulant/limits.h> will provide compile-time constants
#     undef AMBULANT_NO_LIMITS_COMPILE_TIME_CONSTANTS
...
//
#define AMBULANT_HAS_SGI_TYPE_TRAITS

#define AMBULANT_STDLIB "SGI standard library"
