...
#  endif
#  if !(defined(_HAS_MEMBER_TEMPLATES_REBIND) && (_HAS_MEMBER_TEMPLATES_REBIND+0 > 0)) && !(defined(_MSC_VER) && (_MSC_VER > 1300)) && defined(AMBULANT_MSVC)
...
// and no <slist> at all
#else
#  define AMBULANT_MSVC_STD_ITERATOR 1
...
#  define AMBULANT_HAS_MACRO_USE_FACET
#  ifndef _CPPLIB_VER
      // Updated Dinkum library defines this, and provides
      // its own min and max definitions.
#     define AMBULANT_NO_STD_MIN_MAX
#     define AMBULANT_NO_MS_INT64_NUMERIC_LIMITS
#  endif
#endif
...
#ifdef _CPPLIB_VER
#  define AMBULANT_DINKUMWARE_STDLIB _CPPLIB_VER
#else
#  define AMBULANT_DINKUMWARE_STDLIB 1
#endif

#ifdef _CPPLIB_VER
#  define AMBULANT_STDLIB "Dinkumware standard library version " AMBULANT_STRINGIZE(_CPPLIB_VER)
#else
#  define AMBULANT_STDLIB "Dinkumware standard library version 1.x"
#endif
