...
#if (__BORLANDC__ <= 0x570) || !defined(AMBULANT_STRICT_CONFIG)
...
#     pragma defineonoption AMBULANT_CPPUNWIND -x
#  endif
#endif
...
//
#if !defined(_CPPUNWIND) && !defined(AMBULANT_CPPUNWIND)
...
//
#pragma defineonoption AMBULANT_DISABLE_WIN32 -A

#define AMBULANT_COMPILER "Borland C++ version " AMBULANT_STRINGIZE(__BORLANDC__)
