...
#    if (__SUNPRO_CC <= 0x530) || !defined(AMBULANT_STRICT_CONFIG)
...
#    if (__SUNPRO_CC <= 0x540) || !defined(AMBULANT_STRICT_CONFIG)
#      define AMBULANT_NO_TEMPLATE_TEMPLATES
#    endif

#define AMBULANT_COMPILER "Sun compiler version " AMBULANT_STRINGIZE(__SUNPRO_CC)
