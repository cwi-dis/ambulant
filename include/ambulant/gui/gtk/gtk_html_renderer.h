...
#ifndef AMBULANT_GUI_GTK_HTML_RENDERER_H
#define AMBULANT_GUI_GTK_HTML_RENDERER_H

//#define WITH_GTK_HTML_WIDGET
...
class gtk_html_renderer : public renderer_playable {
  public:
	gtk_html_renderer(
...
#endif/*AMBULANT_GUI_GTK_HTML_RENDERER_H*/
