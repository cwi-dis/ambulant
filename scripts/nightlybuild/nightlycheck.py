...
URLS={
    ...
    'ubuntu-12.04-source' : [
        "http://ambulantplayer.org/nightlybuilds/default/deb/dists/12.04/ambulant/source/debian-%(ydate)s/ambulant_2.5.%(ydate)s%%7Eprecise.dsc",
        "http://ambulantplayer.org/nightlybuilds/default/deb/dists/12.04/ambulant/source/debian-%(ydate)s/ambulant_2.5.%(ydate)s%%7Eprecise.tar.gz",
        "http://ambulantplayer.org/nightlybuilds/default/deb/dists/12.04/ambulant/source/debian-%(ydate)s/ambulant_2.5.%(ydate)s%%7Eprecise_amd64.build",
        "http://ambulantplayer.org/nightlybuilds/default/deb/dists/12.04/ambulant/source/debian-%(ydate)s/ambulant_2.5.%(ydate)s%%7Eprecise_source.build",
        "http://ambulantplayer.org/nightlybuilds/default/deb/dists/12.04/ambulant/source/debian-%(ydate)s/ambulant_2.5.%(ydate)s%%7Eprecise_source.changes",
    ],
    'ubuntu-12.04-amd64' : [
        "http://ambulantplayer.org/nightlybuilds/default/deb/dists/12.04/ambulant/binary-amd64/debian-%(ydate)s/ambulant-common_2.5.%(ydate)s%%7Eprecise_amd64.deb",
        "http://ambulantplayer.org/nightlybuilds/default/deb/dists/12.04/ambulant/binary-amd64/debian-%(ydate)s/ambulant-gtk_2.5.%(ydate)s%%7Eprecise_amd64.deb",
        "http://ambulantplayer.org/nightlybuilds/default/deb/dists/12.04/ambulant/binary-amd64/debian-%(ydate)s/ambulant-plugins-dev_2.5.%(ydate)s%%7Eprecise_amd64.deb",
        "http://ambulantplayer.org/nightlybuilds/default/deb/dists/12.04/ambulant/binary-amd64/debian-%(ydate)s/ambulant-plugins_2.5.%(ydate)s%%7Eprecise_amd64.deb",
        "http://ambulantplayer.org/nightlybuilds/default/deb/dists/12.04/ambulant/binary-amd64/debian-%(ydate)s/ambulant-python_2.5.%(ydate)s%%7Eprecise_amd64.deb",
        "http://ambulantplayer.org/nightlybuilds/default/deb/dists/12.04/ambulant/binary-amd64/debian-%(ydate)s/ambulant-sdl_2.5.%(ydate)s%%7Eprecise_amd64.deb",
        "http://ambulantplayer.org/nightlybuilds/default/deb/dists/12.04/ambulant/binary-amd64/debian-%(ydate)s/libambulant_2.5.%(ydate)s%%7Eprecise_amd64.deb",
        "http://ambulantplayer.org/nightlybuilds/default/deb/dists/12.04/ambulant/binary-amd64/debian-%(ydate)s/libambulant-dev_2.5.%(ydate)s%%7Eprecise_amd64.deb",
        "http://ambulantplayer.org/nightlybuilds/default/deb/dists/12.04/ambulant/binary-amd64/debian-%(ydate)s/ambulant_2.5.%(ydate)s%%7Eprecise.dsc",
        "http://ambulantplayer.org/nightlybuilds/default/deb/dists/12.04/ambulant/binary-amd64/debian-%(ydate)s/ambulant_2.5.%(ydate)s%%7Eprecise_amd64.changes",
    ],
    'ubuntu-12.04-i386' : [
        "http://ambulantplayer.org/nightlybuilds/default/deb/dists/12.04/ambulant/binary-i386/debian-%(ydate)s/ambulant-common_2.5.%(ydate)s%%7Eprecise_i386.deb",
        "http://ambulantplayer.org/nightlybuilds/default/deb/dists/12.04/ambulant/binary-i386/debian-%(ydate)s/ambulant-gtk_2.5.%(ydate)s%%7Eprecise_i386.deb",
        "http://ambulantplayer.org/nightlybuilds/default/deb/dists/12.04/ambulant/binary-i386/debian-%(ydate)s/ambulant-plugins-dev_2.5.%(ydate)s%%7Eprecise_i386.deb",
        "http://ambulantplayer.org/nightlybuilds/default/deb/dists/12.04/ambulant/binary-i386/debian-%(ydate)s/ambulant-plugins_2.5.%(ydate)s%%7Eprecise_i386.deb",
        "http://ambulantplayer.org/nightlybuilds/default/deb/dists/12.04/ambulant/binary-i386/debian-%(ydate)s/ambulant-python_2.5.%(ydate)s%%7Eprecise_i386.deb",
        "http://ambulantplayer.org/nightlybuilds/default/deb/dists/12.04/ambulant/binary-i386/debian-%(ydate)s/ambulant-sdl_2.5.%(ydate)s%%7Eprecise_i386.deb",
        "http://ambulantplayer.org/nightlybuilds/default/deb/dists/12.04/ambulant/binary-i386/debian-%(ydate)s/libambulant_2.5.%(ydate)s%%7Eprecise_i386.deb",
        "http://ambulantplayer.org/nightlybuilds/default/deb/dists/12.04/ambulant/binary-i386/debian-%(ydate)s/libambulant-dev_2.5.%(ydate)s%%7Eprecise_i386.deb",
        "http://ambulantplayer.org/nightlybuilds/default/deb/dists/12.04/ambulant/binary-i386/debian-%(ydate)s/ambulant_2.5.%(ydate)s%%7Eprecise.dsc",
        "http://ambulantplayer.org/nightlybuilds/default/deb/dists/12.04/ambulant/binary-i386/debian-%(ydate)s/ambulant_2.5.%(ydate)s%%7Eprecise_i386.changes",
    ],
    'ubuntu-12.04-amd64-PPA' : [
         "http://ppa.launchpad.net/ambulant/ambulant-nightly/ubuntu/pool/main/a/ambulant/ambulant-common_2.5.%(ydate)s%%7Eprecise_amd64.deb",
        "http://ppa.launchpad.net/ambulant/ambulant-nightly/ubuntu/pool/main/a/ambulant/ambulant-gtk_2.5.%(ydate)s%%7Eprecise_amd64.deb",
        "http://ppa.launchpad.net/ambulant/ambulant-nightly/ubuntu/pool/main/a/ambulant/ambulant-plugins-dev_2.5.%(ydate)s%%7Eprecise_amd64.deb",
        "http://ppa.launchpad.net/ambulant/ambulant-nightly/ubuntu/pool/main/a/ambulant/ambulant-plugins_2.5.%(ydate)s%%7Eprecise_amd64.deb",
        "http://ppa.launchpad.net/ambulant/ambulant-nightly/ubuntu/pool/main/a/ambulant/ambulant-python_2.5.%(ydate)s%%7Eprecise_amd64.deb",
        "http://ppa.launchpad.net/ambulant/ambulant-nightly/ubuntu/pool/main/a/ambulant/ambulant-sdl_2.5.%(ydate)s%%7Eprecise_amd64.deb",
        "http://ppa.launchpad.net/ambulant/ambulant-nightly/ubuntu/pool/main/a/ambulant/libambulant_2.5.%(ydate)s%%7Eprecise_amd64.deb",
        "http://ppa.launchpad.net/ambulant/ambulant-nightly/ubuntu/pool/main/a/ambulant/libambulant-dev_2.5.%(ydate)s%%7Eprecise_amd64.deb",
        "http://ppa.launchpad.net/ambulant/ambulant-nightly/ubuntu/pool/main/a/ambulant/ambulant_2.5.%(ydate)s%%7Eprecise.dsc",
    ],
    'ubuntu-12.04-i386-PPA' : [
        "http://ppa.launchpad.net/ambulant/ambulant-nightly/ubuntu/pool/main/a/ambulant/ambulant-common_2.5.%(ydate)s%%7Eprecise_i386.deb",
        "http://ppa.launchpad.net/ambulant/ambulant-nightly/ubuntu/pool/main/a/ambulant/ambulant-gtk_2.5.%(ydate)s%%7Eprecise_i386.deb",
        "http://ppa.launchpad.net/ambulant/ambulant-nightly/ubuntu/pool/main/a/ambulant/ambulant-plugins-dev_2.5.%(ydate)s%%7Eprecise_i386.deb",
        "http://ppa.launchpad.net/ambulant/ambulant-nightly/ubuntu/pool/main/a/ambulant/ambulant-plugins_2.5.%(ydate)s%%7Eprecise_i386.deb",
        "http://ppa.launchpad.net/ambulant/ambulant-nightly/ubuntu/pool/main/a/ambulant/ambulant-python_2.5.%(ydate)s%%7Eprecise_i386.deb",
        "http://ppa.launchpad.net/ambulant/ambulant-nightly/ubuntu/pool/main/a/ambulant/ambulant-sdl_2.5.%(ydate)s%%7Eprecise_i386.deb",
        "http://ppa.launchpad.net/ambulant/ambulant-nightly/ubuntu/pool/main/a/ambulant/libambulant_2.5.%(ydate)s%%7Eprecise_i386.deb",
        "http://ppa.launchpad.net/ambulant/ambulant-nightly/ubuntu/pool/main/a/ambulant/libambulant-dev_2.5.%(ydate)s%%7Eprecise_i386.deb",
        "http://ppa.launchpad.net/ambulant/ambulant-nightly/ubuntu/pool/main/a/ambulant/ambulant_2.5.%(ydate)s%%7Eprecise.dsc",
    ],
