...
CONFIGOPTS="$PREFIX $AMBULANT_FFMPEG_DEBUG_FLAGS --disable-encoders --enable-runtime-cpudetect --enable-gpl --disable-ffserver --disable-ffmpeg --disable-ffplay --disable-ffprobe --enable-static --enable-shared --cc=/Developer/usr/bin/gcc"
#
