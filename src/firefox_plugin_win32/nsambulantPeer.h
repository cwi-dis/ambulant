...
// ==============================
//
// nsambulantPeer - xpconnect ambulant peer
//

#ifndef __nsambulantPeer_h__
#define __nsambulantPeer_h__

#include "nsIambulantPluginSample.h"
...
class nsambulantPeer : public nsIambulantPluginSample,
                         public nsClassInfoMixin
{
public:
  nsambulantPeer(nsPluginInstance* plugin);
  ~nsambulantPeer();
