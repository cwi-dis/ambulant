...
##          ),
    ...
    'iOS-Simulator' : [
        ...
        TPP("SDL",
            ...
            buildcmd=
                "cd SDL-1.3.0-*  && "
                "echo skip: patch --strip 1 --forward < %s/third_party_packages/sdl-iOS-patches.patch && "
                "cd Xcode-iphoneOS/SDL  && "
...
##          ),
    ...
    'linux' : [
        ...
        TPP("xulrunner-sdk",
            url="http://releases.mozilla.org/pub/mozilla.org/xulrunner/releases/1.9.2.13/sdk/xulrunner-1.9.2.13.en-US.linux-i686.sdk.tar.bz2",
