...
<!-- file: smil-attribs-1.mod
      ...
      This is SMIL 3.0.
        ...
        Editor for previous versions of SMIL: Warner ten Kate, Jacco van Ossenbruggen, Sjoerd Mullender
        $Revision$
        $Date$
     ...
     SYSTEM "http://www.w3.org/2007/SMIL30/smil-attribs-1.mod"
...
<![%SMIL.IncludeModuleNamespaces;[
  <!ENTITY % SMIL.ModuleNamespaces "
    xmlns:Structure %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/Structure'
    xmlns:Identity %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/Identity'
    xmlns:BasicMedia %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/BasicMedia'
    xmlns:BrushMedia %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/BrushMedia'
    xmlns:MediaAccessibility %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/MediaAccessibility'
    xmlns:MediaClipMarkers %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/MediaClipMarkers'
    xmlns:MediaClipping %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/MediaClipping'
    xmlns:MediaDescription %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/MediaDescription'
    xmlns:MediaOpacity %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/MediaOpacity'
    xmlns:MediaPanZoom %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/MediaPanZoom'
    xmlns:MediaParam %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/MediaParam'
    xmlns:MediaRenderAttributes %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/MediaRenderAttributes'
    xmlns:AccessKeyTiming %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/AccessKeyTiming'
    xmlns:BasicExclTimeContainers %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/BasicExclTimeContainers'
    xmlns:BasicInlineTiming %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/BasicInlineTiming'
    xmlns:BasicPriorityClassContainers %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/BasicPriorityClassContainers'
    xmlns:BasicTimeContainers %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/BasicTimeContainers'
    xmlns:DOMTimingMethods %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/DOMTimingMethods'
    xmlns:EventTiming %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/EventTiming'
    xmlns:FillDefault %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/FillDefault'
    xmlns:MediaMarkerTiming %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/MediaMarkerTiming'
    xmlns:MinMaxTiming %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/MinMaxTiming'
    xmlns:MultiArcTiming %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/MultiArcTiming'
    xmlns:RepeatTiming %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/RepeatTiming'
    xmlns:RepeatValueTiming %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/RepeatValueTiming'
    xmlns:RestartDefault %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/RestartDefault'
    xmlns:RestartTiming %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/RestartTiming'
    xmlns:SyncbaseTiming %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/SyncbaseTiming'
    xmlns:SyncBehaviorDefault %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/SyncBehaviorDefault'
    xmlns:SyncBehavior %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/SyncBehavior'
    xmlns:SyncMaster %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/SyncMaster'
    xmlns:TimeContainerAttributes %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/TimeContainerAttributes'
    xmlns:WallclockTiming %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/WallclockTiming'
    xmlns:BasicContentControl %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/BasicContentControl'
    xmlns:CustomTestAttributes %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/CustomTestAttributes'
    xmlns:PrefetchControl %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/PrefetchControl'
    xmlns:RequiredContentControl %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/RequiredContentControl'
    xmlns:SkipContentControl %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/SkipContentControl'
    xmlns:AlignmentLayout %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/AlignmentLayout'
    xmlns:AudioLayout %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/AudioLayout'
    xmlns:BackgroundTilingLayout %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/BackgroundTilingLayout'
    xmlns:BasicLayout %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/BasicLayout'
    xmlns:MultiWindowLayout %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/MultiWindowLayout'
    xmlns:OverrideLayout %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/OverrideLayout'
    xmlns:StructureLayout %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/StructureLayout'
    xmlns:SubRegionLayout %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/SubRegionLayout'
    xmlns:BasicText %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/BasicText'
    xmlns:TextMotion %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/TextMotion'
    xmlns:TextStyling %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/TextStyling'
    xmlns:BasicLinking %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/BasicLinking'
    xmlns:LinkingAttributes %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/LinkingAttributes'
    xmlns:ObjectLinking %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/ObjectLinking'
    xmlns:Metainformation %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/Metainformation'
    xmlns:BasicTransitions %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/BasicTransitions'
    xmlns:FullScreenTransitionEffects %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/FullScreenTransitionEffects'
    xmlns:InlineTransitions %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/InlineTransitions'
    xmlns:TransitionModifiers %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/TransitionModifiers'
    xmlns:BasicAnimation %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/BasicAnimation'
    xmlns:SplineAnimation %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/SplineAnimation'
    xmlns:StateInterpolation %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/StateInterpolation'
    xmlns:StateSubmission %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/StateSubmission'
    xmlns:StateTest %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/StateTest'
    xmlns:UserState %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/UserState'
    xmlns:TimeManipulations %URI.datatype; #FIXED 'http://www.w3.org/2007/07/SMIL30/TimeManipulations'
  ">
]]>
<!ENTITY % SMIL.ModuleNamespaces "">
