...
<!-- file: SMIL-media.mod
     ...
     This is SMIL 3.0.
        ...
        Editor for previous versions of SMIL: Rob Lanphier, Jacco van Ossenbruggen,, Sjoerd Mullender Sjoerd Mullender
        $Revision$
        $Date$
     ...
     SYSTEM "http://www.w3.org/2007/SMIL30/SMIL-media.mod"
