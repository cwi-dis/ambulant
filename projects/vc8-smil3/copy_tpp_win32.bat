...
REM libxml2, if it exists
set XML2_BUILD=%TPP_HOME%\libxml2-2.6.29\win32
if exist %XML2_BUILD% copy %XML2_BUILD%\bin.msvc\libxml2_a.lib %AMB_HOME%\lib\win32\libxml2_a.lib
