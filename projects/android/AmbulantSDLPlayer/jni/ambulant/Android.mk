...
LOCAL_CFLAGS := -DWITH_EXPAT -DWITH_SDL2 -DANDROID -DWITH_SDL_IMAGE -DWITH_SDL_TTF -DWITH_FFMPEG

LOCAL_SHARED_LIBRARIES := ambulant SDL2 SDL2_image SDL2_ttf expat gnust_shared libavformat libavcodec libswresample libswscale libavutil
...
LOCAL_SRC_FILES := src/libambulant/lib/gpaths.cpp \
	...
	src/libambulant/net/demux_datasource.cpp \
	src/libambulant/net/ffmpeg_audio.cpp \
	src/libambulant/net/ffmpeg_common.cpp \
	src/libambulant/net/ffmpeg_raw.cpp \
	src/libambulant/net/ffmpeg_video.cpp \
...
$(call import-module,ffmpeg-2.0.2/android/arm)
